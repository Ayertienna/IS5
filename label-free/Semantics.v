...
intros. rewrite Mem_cons_eq in H3; destruct H3.
  ...
  replace ({{fctx w // bctx 0}}[N | fctx w0, 0]) with 
    ({{fctx w // fctx w1}} [ {{fctx w1 // bctx 0}} [ N | fctx w0, length (@nil te_LF)] | fctx w0, length (A::nil)]).
